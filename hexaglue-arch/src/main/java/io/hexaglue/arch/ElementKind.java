...
public enum ElementKind {
    ...
    /**
     * Returns {@code true} if this is a port type (DRIVING_PORT, DRIVEN_PORT, or APPLICATION_SERVICE).
     *
     * @return true if this element is a port
     */
    public boolean isPort() {
        return this == DRIVING_PORT || this == DRIVEN_PORT || this == APPLICATION_SERVICE;
    }
    ...
    public boolean isDomain() {
        return !isPort() && !isAdapter() && this != UNCLASSIFIED;
    }
}
