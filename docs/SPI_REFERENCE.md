...
| `COMPOSITE` | Multi-property composite ID (maps to JPA `@EmbeddedId`) |
...
> **Note**: Plugin configuration is available via `hexaglue.yaml` in your project root. See [Configuration Reference](CONFIGURATION.md#plugin-configuration-hexaglueyaml) for details.
