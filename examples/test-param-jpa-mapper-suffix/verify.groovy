...
def bookMap = new File(basedir, 'target/hexaglue/generated-sources/com/example/infrastructure/persistence/BookMap.java')
assert bookMap.exists(): 'BookMap.java should be generated with custom mapperSuffix'

def bookMapper = new File(basedir, 'target/hexaglue/generated-sources/com/example/infrastructure/persistence/BookMapper.java')
