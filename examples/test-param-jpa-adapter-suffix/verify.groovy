...
def bookRepositoryImpl = new File(basedir, 'target/generated-sources/hexaglue/com/example/infrastructure/persistence/BookRepositoryImpl.java')
assert bookRepositoryImpl.exists(): 'BookRepositoryImpl.java should be generated with custom adapterSuffix'

def bookRepositoryAdapter = new File(basedir, 'target/generated-sources/hexaglue/com/example/infrastructure/persistence/BookRepositoryAdapter.java')
