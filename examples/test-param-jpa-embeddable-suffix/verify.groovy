...
def addressEmb = new File(basedir, 'target/hexaglue/generated-sources/com/example/infrastructure/persistence/AddressEmb.java')
assert addressEmb.exists(): 'AddressEmb.java should be generated with custom embeddableSuffix'

def addressEmbeddable = new File(basedir, 'target/hexaglue/generated-sources/com/example/infrastructure/persistence/AddressEmbeddable.java')
