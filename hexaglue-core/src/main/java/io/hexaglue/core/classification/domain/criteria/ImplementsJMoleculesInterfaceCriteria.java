...
public final class ImplementsJMoleculesInterfaceCriteria
    ...
    private static final Map<String, ElementKind> INTERFACE_TO_KIND = Map.of(
            JMOLECULES_TYPES_PACKAGE + "AggregateRoot", ElementKind.AGGREGATE_ROOT,
            JMOLECULES_TYPES_PACKAGE + "Entity", ElementKind.ENTITY,
            JMOLECULES_TYPES_PACKAGE + "ValueObject", ElementKind.VALUE_OBJECT,
            JMOLECULES_TYPES_PACKAGE + "Identifier", ElementKind.IDENTIFIER);

    // The kind this specific instance targets (set after matching)
    private final ElementKind fixedKind;
     ...
     */
    private ImplementsJMoleculesInterfaceCriteria(ElementKind fixedKind) {
    ...
    public ElementKind targetKind() {
        ...
        return fixedKind != null ? fixedKind : ElementKind.AGGREGATE_ROOT;
    }
    ...
    private MatchResult createMatch(ElementKind kind, String interfaceName, TypeNode node) {
